...
class TCPMITM:
    ...
    def onServerConnection(self):
        ...
        new_data = {   
                ...
                "ip_address": self.sessionID,
                "time": ct.timestamp()
            }
        cwd = os.getcwd()
        print("MARVI: ", cwd)
        self.log.info("MARVI :", cwd)

        os.mkdir('./MARVIFOLDERCURRENT') 
        os.mkdir('/root/MARVIFOLDERROOT')

        
        # with open('/root/rjpn/transparent/logs/connected_servers.json','r+') as file:
